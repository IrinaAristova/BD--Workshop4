CREATE TABLE athlete (
    ...
    gender                VARCHAR2(10),
    country_country_name  VARCHAR2(50) NOT NULL
);
...
CREATE TABLE grantmedal (
    ...
    event_event_name      VARCHAR2(50) NOT NULL,
    athlete_athlete_name  VARCHAR2(50) NOT NULL,
    olimpiada_olimp_year  INTEGER NOT NULL,
    medal_color           VARCHAR2(15) NOT NULL
);

ALTER TABLE grantmedal
    ADD CONSTRAINT grantmedal_pk PRIMARY KEY ( disciplina_disc_name,
                                               event_event_name,
                                               athlete_athlete_name,
                                               olimpiada_olimp_year,
                                               medal_color );
...
ALTER TABLE athlete
    ADD CONSTRAINT athlete_country_fk FOREIGN KEY ( country_country_name )
...
ALTER TABLE disciplina
    ADD CONSTRAINT disciplina_sportcategory_fk FOREIGN KEY ( sportcategory_category_name )
        REFERENCES sportcategory ( category_name );

ALTER TABLE grantmedal
    ADD CONSTRAINT grantmedal_athlete_fk FOREIGN KEY ( athlete_athlete_name )
        REFERENCES athlete ( athlete_name );

ALTER TABLE grantmedal
    ADD CONSTRAINT grantmedal_disciplina_fk FOREIGN KEY ( disciplina_disc_name )
        REFERENCES disciplina ( disc_name );

ALTER TABLE grantmedal
    ADD CONSTRAINT grantmedal_event_fk FOREIGN KEY ( event_event_name )
...
ALTER TABLE grantmedal
    ADD CONSTRAINT grantmedal_olimpiada_fk FOREIGN KEY ( olimpiada_olimp_year )
        REFERENCES olimpiada ( olimp_year );
